                ...
                >
                  <div className="glass-card p-4 mb-4 space-y-3 border border-primary/20">
                    ...
                    <Input
                      ...
                      placeholder="e.g., Math Study Group, FYP Team..."
                      className="text-sm"
                      onKeyDown={(e) => e.key === "Enter" && handleCreate()}
                      autoFocus
                    />
                    <p className="text-[11px] text-muted-foreground">
                      You'll get an invite code to share with up to 6 friends.
                    </p>
              ...
              {showJoin && (
                ...
                >
                  <div className="glass-card p-4 mb-4 space-y-3 border border-accent/40">
                    ...
                    />
                    <p className="text-[11px] text-muted-foreground">
                      Ask a room member to share their invite code with you.
                    </p>
                    <div className="flex gap-2">
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground mb-5 leading-relaxed">
        Create a room and invite friends, or join an existing room with an invite code.
      </p>

      <div className="space-y-2">
        <Button size="sm" onClick={onCreateClick} className="w-full gap-1.5">
          <Plus className="w-4 h-4" /> Create Your First Room
        </Button>
        <Button size="sm" variant="outline" onClick={onJoinClick} className="w-full gap-1.5">
          <UserPlus className="w-4 h-4" /> Join with Invite Code
        </Button>
      </div>
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center max-w-xs">
      ...
      <p className="text-sm text-muted-foreground mb-6">
        Pick a study room from the sidebar to start chatting, sharing files, or hopping on a call.
      </p>
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground">
                {members.length} member{members.length !== 1 ? "s" : ""} • Max 7
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-0.5">
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={() => handleStartCall(false)} className="h-8 w-8">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={() => handleStartCall(true)} className="h-8 w-8">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" onClick={copyInvite} className="h-8 w-8">
            ...
            <Tooltip>
              ...
              <TooltipContent>Members ({members.length}/7)</TooltipContent>
            </Tooltip>
            ...
            <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden border-b border-border">
              <div className="p-3">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Button variant="ghost" size="sm" onClick={copyInvite} className="h-6 text-[10px] gap-1">
                  ...
                  {members.map((m) => (
                    <div key={m.id} className="flex items-center gap-2 bg-muted/50 rounded-full px-3 py-1.5">
                      ...
                      {m.user_id === room.created_by && (
                        <span className="text-[9px] bg-primary/10 text-primary px-1.5 py-0.5 rounded-full font-medium">Owner</span>
                      )}
                      {m.user_id === userId && (
            ...
            {messages.length === 0 && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-12">
                ...
                <p className="text-xs text-muted-foreground mb-4 max-w-[250px] mx-auto">
                  Start the conversation! You can send messages, share files, or start a video call.
                </p>
        ...
        <div className="p-3 border-t border-border">
          <div className="flex items-center gap-2">
            ...
            <Tooltip>
              ...
              <TooltipContent>Attach file (max 20MB)</TooltipContent>
            </Tooltip>
          ...
          <p className="text-[10px] text-muted-foreground/60 mt-1.5 ml-11">
            Press Enter to send • Attach PDFs, images & documents
          </p>
        </div>
      </div>
    </>
